...
var displayMap = function displayMap(location) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWVobWV0YWtpZiIsImEiOiJja2E5YzdyeWUwNG5zMnJydXVvZnI3aDFwIn0.f2kvGJHCOM3AKQ5ct0ehLw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mehmetakif/cka9f3q2v37xd1iquokfuc555',
    scrollZoom: false //center: [-118.118223, 33.897006],
    //zoom: 5
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " update is successful"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1);
            }
